...
[^4]: SQuAD v1.1 dataset: https://rajpurkar.github.io/SQuAD-explorer/
...
The DistilBERT model is available for use through Hugging Face's transformers library (Wolf et al., 2019). In the original research, DistilBERT was evaluated using three datasets: the GLUE (General Language Understanding and Evaluation) benchmark [^2], which includes nine sentence-pair language understanding tasks; IMDb [^3], used for sentiment classification of user movie reviews; and SQuAD [^4] (Stanford Question Answering Dataset), designed for question-answering based on a provided passage.
